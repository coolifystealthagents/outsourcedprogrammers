...
export const september7ResearchSource: ReadonlyArray<ResearchPost> = [
  {
    slug: "research-review-queue-wait-state-analysis-2026",
    title: "What review queue data leaves unexplained",
    excerpt:
  ...
  {
    slug: "research-synthetic-fixture-boundaries-2026",
    title:
      "Where synthetic QA fixtures stop being representative",
    excerpt:
  ...
  {
    slug: "research-dependency-update-evidence-reading-2026",
    title: "Reading the evidence behind a dependency update",
    excerpt:
  ...
  {
    slug: "research-incident-handoff-actionability-2026",
    title:
      "When an incident handoff is ready for action",
    excerpt:
  ...
  {
    slug: "research-access-removal-verification-lag-2026",
    title: "The gap between disabling an account and ending access",
    excerpt:
