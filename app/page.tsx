    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Programmer sprint board</p>
          <h1>Outsourced Programmers: a sprint board for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced programmers guide for teams hiring outsourced programmers for app, web, QA, and maintenance work. The page now uses a distinct technical agile layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>sprint lanes and code tabs</figcaption></figure>
      </div>
    </section>
