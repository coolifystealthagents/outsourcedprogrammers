...
import { september2BlogBatch, september2BlogDetails } from './september2-blog-batch';
export const site = {
...
export const blogPosts: ReadonlyArray<{ slug: string; title: string; excerpt: string; minutes: number; published?: string }> = [
  ...
  { slug: "outsource-b2b-portal-qa", title: "Outsource B2B portal QA with account-aware fixtures", excerpt: "Test company switching, invitations, permissions, and empty states without exposing real business records.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-password-reset-qa", title: "Outsource password reset QA with safe test identities", excerpt: "Exercise reset links, expiry, reuse, and recovery messaging while keeping real accounts out of test evidence.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-cart-checkout-qa", title: "Outsource cart and checkout QA with controlled scenarios", excerpt: "Cover quantity changes, unavailable items, retries, and confirmation states using non-production fixtures.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-customer-feedback-widget", title: "Outsource customer feedback widget testing", excerpt: "Verify display rules, keyboard access, validation, and failure recovery without sending feedback to a live queue.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-graphql-error-handling", title: "Outsource GraphQL error handling with useful evidence", excerpt: "Test partial data, field errors, transport failures, and user-safe messages with repeatable fixtures.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-websocket-reliability", title: "Outsource WebSocket reliability testing", excerpt: "Check reconnects, missed events, duplicate messages, and connection loss with an observable test harness.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-frontend-pagination", title: "Outsource frontend pagination QA with boundary cases", excerpt: "Test first, middle, last, empty, and changing-result pages without hiding ordering or loading defects.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-database-backup-verification", title: "Outsource database backup verification safely", excerpt: "Verify backup freshness, restore evidence, and documented gaps without touching live customer data.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-api-idempotency", title: "Outsource API idempotency testing with replay fixtures", excerpt: "Prove repeated requests do not create duplicate effects by testing keys, timeouts, and safe retries.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-role-invitation-qa", title: "Outsource role invitation QA with clear expiry rules", excerpt: "Test invitation creation, acceptance, expiration, resend, and role assignment with isolated accounts.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-document-search-qa", title: "Outsource document search QA with permission boundaries", excerpt: "Test indexing, ranking, filters, and inaccessible results using synthetic document collections.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-browser-storage-review", title: "Outsource browser storage review with privacy safeguards", excerpt: "Inspect cookies, local storage, expiry, and logout behavior without collecting real user values.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-structured-data-audit", title: "Outsource structured data audits with route evidence", excerpt: "Review JSON-LD types, required fields, canonical URLs, and content agreement across representative pages.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-redirect-matrix-testing", title: "Outsource redirect matrix testing for site changes", excerpt: "Check old paths, canonical destinations, loops, query handling, and status codes with a documented matrix.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-cms-preview-qa", title: "Outsource CMS preview QA with draft boundaries", excerpt: "Verify draft, scheduled, preview, and published states without leaking unpublished content to public routes.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-integration-timeout-testing", title: "Outsource integration timeout testing with clear recovery", excerpt: "Exercise slow and unavailable dependencies so user messaging, retries, and failure ownership are explicit.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-queue-dead-letter-review", title: "Outsource dead-letter queue review with recovery evidence", excerpt: "Inspect failure classification, replay controls, retention, and ownership using isolated queue fixtures.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-user-profile-qa", title: "Outsource user profile QA with safe identity fixtures", excerpt: "Test edits, validation, avatars, privacy settings, and cancel behavior without using real profiles.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-passwordless-login-qa", title: "Outsource passwordless login QA with controlled links", excerpt: "Test one-time links, expiry, device changes, and denial paths using isolated inboxes and accounts.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-frontend-loading-states", title: "Outsource frontend loading-state QA with slow fixtures", excerpt: "Make loading, skeleton, retry, and partial-response behavior predictable across important user journeys.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-data-masking-review", title: "Outsource data masking review with safe evidence", excerpt: "Check masked values in logs, exports, and interfaces while preserving the clues needed for diagnosis.", minutes: 9, published: "2026-08-13" },
  { slug: "outsource-report-filter-qa", title: "Outsource report filter QA with fixture-based totals", excerpt: "Test date ranges, combinations, empty results, permissions, and totals against known report fixtures.", minutes: 8, published: "2026-08-13" },
  { slug: "outsource-api-versioning-review", title: "Outsource API versioning review with compatibility evidence", excerpt: "Check version boundaries, deprecation notes, client behavior, and migration evidence before an API change is accepted.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-background-job-testing", title: "Outsource background job testing with repeatable fixtures", excerpt: "Exercise retries, duplicate work, partial failure, and completion records without using live customer jobs.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-component-library-maintenance", title: "Outsource component library maintenance with state coverage", excerpt: "Keep shared interface components consistent by documenting states, examples, keyboard behavior, and review evidence.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-cookie-consent-qa", title: "Outsource cookie consent QA with privacy-aware cases", excerpt: "Check consent choices, persistence, withdrawal, and regional states with synthetic visitors and clear evidence.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-csv-export-validation", title: "Outsource CSV export validation with trusted fixtures", excerpt: "Verify columns, escaping, encoding, filters, and empty results without exporting real customer records.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-date-timezone-qa", title: "Outsource date and timezone QA with boundary cases", excerpt: "Test daylight changes, locale formatting, midnight boundaries, and stored values with explicit expected results.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-invoice-pdf-rendering", title: "Outsource invoice PDF rendering checks with safe data", excerpt: "Review document layout, totals, localization, accessibility, and download behavior using non-production fixtures.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-multi-language-routing", title: "Outsource multilingual routing checks with fallback rules", excerpt: "Verify language paths, redirects, missing translations, metadata, and fallback behavior across representative pages.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-notification-preferences-qa", title: "Outsource notification preference QA with clear opt-outs", excerpt: "Check channel choices, defaults, unsubscribe behavior, and event boundaries with isolated test identities.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-offline-mode-testing", title: "Outsource offline mode testing with recovery evidence", excerpt: "Test disconnected actions, queued changes, conflict states, and recovery using controlled device fixtures.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-permission-audit", title: "Outsource permission audit preparation with role fixtures", excerpt: "Map role capabilities, hidden routes, and sensitive actions without granting an outside worker broad account access.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-product-tour-qa", title: "Outsource product tour QA with usable progression", excerpt: "Review first-run steps, dismissal, keyboard access, responsive placement, and returning-user behavior.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-rate-limit-documentation", title: "Outsource rate-limit documentation with tested examples", excerpt: "Keep API limits, response headers, retry guidance, and examples aligned with observed behavior and owner policy.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-search-filter-qa", title: "Outsource search filter QA with explainable cases", excerpt: "Test combinations, empty results, sorting, permissions, and reset behavior against a known collection.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-service-health-checks", title: "Outsource service health-check review with bounded evidence", excerpt: "Check response meaning, failure signals, timeouts, and ownership without granting infrastructure control.", minutes: 8, published: "2026-08-14" },
  { slug: "outsource-session-concurrency-testing", title: "Outsource concurrent-session testing with safe identities", excerpt: "Exercise sign-in across devices, logout behavior, expiry, and session limits without using real user accounts.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-subscription-state-qa", title: "Outsource subscription-state QA with controlled fixtures", excerpt: "Verify trial, active, paused, canceled, and past-due states while account and payment decisions stay with the owner.", minutes: 9, published: "2026-08-14" },
  { slug: "outsource-table-sort-qa", title: "Outsource table sorting QA with deterministic fixtures", excerpt: "Check text, numeric, date, null, and multi-column ordering with visible expected results and stable test data.", minutes: 8, published: "2026-08-14" },
...
for (const post of blogPosts.filter((item) => item.published === '2026-08-13')) {
  aug13Focus[post.slug] = { heading: post.title, paragraphs: [post.excerpt, post.title+' starts with a controlled fixture, an expected result, and evidence for the boundary cases that matter.', 'Record the observed behavior and keep sensitive access, policy, and release authority with the company owner.'], bullets: ['Define the fixture and expected result.', 'Test the important boundary case.', 'Record evidence without sensitive data.', 'Escalate unclear ownership.'] };
...
const aug14Angles: Record<string, readonly [string, string, string]> = {
  "outsource-api-versioning-review": ["Compare versions before changing the contract.", "List every supported version, its clients, and the behavior that must remain compatible. A version review is useful when it names the exact request and response differences rather than treating a route as an isolated file.", "Use representative requests to compare status codes, fields, defaults, and error responses. Record which clients were checked, which migration notes are still needed, and who approves a deprecation decision."],
  "outsource-background-job-testing": ["Make asynchronous work observable before handing it off.", "A background job needs a fixture that can be queued, retried, interrupted, and completed without touching live customer work. Define the expected record after each stage.", "Check duplicate delivery, partial failure, retry limits, and a stuck job. The handoff should link the fixture, observed state, logs with sensitive values removed, and the owner for unresolved behavior."],
  "outsource-component-library-maintenance": ["Treat shared components as contracts, not isolated markup.", "Give the programmer a component inventory and the states that matter: loading, empty, error, disabled, focus, and responsive layouts. Include approved examples so visual changes have a reference.", "Review one component at a time with keyboard checks and usage examples. Keep design decisions and broad visual changes with the product owner while the programmer supplies a focused diff and evidence."],
  "outsource-cookie-consent-qa": ["Test choices, persistence, and withdrawal as separate behaviors.", "Use synthetic visitors in each relevant region or policy state. Record what appears before a choice, what is stored after consent, and which optional behavior remains disabled.", "Repeat the flow after refresh and withdrawal. Keep the test evidence free of real identifiers and escalate legal or policy interpretation to the company owner."],
  "outsource-csv-export-validation": ["Validate an export as a data contract.", "Start with a fixture containing commas, quotes, line breaks, Unicode, nulls, and long values. Define the expected headers, row count, encoding, and filter scope before inspection.", "Open the file with more than one parser and compare it with the fixture. Report truncation, escaping, ordering, or access defects without exporting real customer data."],
  "outsource-date-timezone-qa": ["Make time behavior explicit at the boundaries.", "Choose dates around midnight, daylight-saving transitions, leap days, and two user locales. State whether each value represents an instant, a calendar date, or a local appointment.", "Compare stored values, API values, and displayed values separately. A useful handoff names the timezone assumptions and leaves product policy decisions with the owner."],
  "outsource-invoice-pdf-rendering": ["Review generated documents with safe, varied fixtures.", "Use non-production data with long names, missing optional fields, multiple tax lines, and different locales. Define the expected page count, labels, totals, and download name.", "Inspect the PDF visually and extract its text to catch clipped or inaccessible content. Keep financial policy and approval decisions with the company while the programmer documents the rendering evidence."],
  "outsource-multi-language-routing": ["Check language paths as a connected route system.", "List translated, untranslated, and unsupported paths with their expected fallback. Include metadata and internal links so a route that looks correct is not the only evidence.", "Test direct visits, language switches, missing content, and browser refresh. Record redirect loops or mixed-language pages and identify the owner for approved copy or routing policy."],
  "outsource-notification-preferences-qa": ["Connect preferences to the events they control.", "Create isolated identities with each channel enabled, disabled, and unset. Map which event should be suppressed or delivered and what the interface should show after saving.", "Check persistence, unsubscribe behavior, and a later sign-in. Do not send messages to real recipients; report the fixture and observed event decision for owner review."],
  "outsource-offline-mode-testing": ["Define what the product promises when a device disconnects.", "Use a controlled network toggle and name which actions may queue, which must fail, and how the interface communicates uncertainty. Include a conflict fixture rather than assuming reconnection is always clean.", "Reconnect and compare local, server, and displayed state. Record duplicate or lost changes and keep conflict policy and customer-impact decisions with the company owner."],
  "outsource-permission-audit": ["Turn a role list into evidence about real actions.", "Map each role to visible pages, API actions, export paths, and administrative controls using isolated fixtures. Include direct URL and denied-action cases so hidden navigation is not mistaken for protection.", "Compare expected and observed access, then report the smallest missing or excessive permission. Security exceptions and access changes require a named company decision."],
  "outsource-product-tour-qa": ["Measure whether a first-run guide helps without trapping users.", "Define the starting condition, each step, dismissal behavior, keyboard path, and responsive placement. Include a returning user who has already completed the guide.", "Check refresh, back navigation, reduced-motion behavior, and a missing target. Keep product copy and onboarding policy with the owner while the programmer provides reproducible findings."],
  "outsource-rate-limit-documentation": ["Make public API guidance agree with observed behavior.", "Use safe requests to record limit headers, status codes, retry signals, and scope assumptions. Examples should show the smallest useful request and explain what clients should do after rejection.", "Compare the draft with a controlled test and note any undocumented exception. Keep policy and compatibility decisions with the API owner; publish only reviewed examples."],
  "outsource-search-filter-qa": ["Use a known collection to make filter results explainable.", "Create fixtures that differ on each searchable field, permission, date, and empty condition. Define expected counts and ordering for single filters and important combinations.", "Check apply, reset, refresh, and direct-link behavior. Record whether the defect is filtering, ranking, access, or presentation so the next owner can act without recreating the whole investigation."],
  "outsource-service-health-checks": ["Review health signals for meaning, not just a green response.", "Name the dependency, expected response, timeout, and failure classification for each check. A useful check distinguishes readiness, liveness, and a degraded dependency where those concepts differ.", "Exercise safe failure fixtures and record the resulting signal and owner. Do not grant infrastructure control for an evidence-gathering task; escalate ambiguous operational policy."],
  "outsource-session-concurrency-testing": ["Test sessions across devices with isolated identities.", "Use two or more safe accounts and define expected behavior for sign-in, logout, expiry, password change, and a session limit. Capture only synthetic identifiers in the evidence.", "Repeat after refresh and a network interruption. Report stale access or surprising invalidation with timestamps and steps, while authentication policy remains a company decision."],
  "outsource-subscription-state-qa": ["Separate account states from payment decisions.", "Create non-production fixtures for trial, active, paused, canceled, and past-due states. Define which features, notices, and transitions each state should expose without using real billing records.", "Check refresh, renewal, cancellation, and an unavailable dependency. Keep entitlement policy and account action approval with the owner; the programmer reports the observed state transitions."],
  "outsource-table-sort-qa": ["Make ordering defects visible with deterministic rows.", "Include duplicate values, nulls, mixed case, negative numbers, dates, and long text. Define ascending and descending expectations before interacting with the table.", "Check header labels, keyboard access, pagination interaction, and refresh persistence. A concise handoff includes the fixture order and the first row where observed behavior diverges."],
  "outsource-timezone-data-migration": ["Treat timezone changes as a data decision with a reversible plan.", "Inventory the field meaning, current storage convention, affected records, and conversion rule. Separate timestamps from local dates before estimating the impact of a migration.", "Run the conversion on a copy and compare counts, samples, and rollback output. Keep approval for customer-facing time interpretation and data changes with the technical owner."],
  "outsource-user-export-qa": ["Test export scope and access before inspecting file quality.", "Use synthetic accounts with records that belong and do not belong in the export. Define who can request it, which fields appear, and how an empty export behaves.", "Check the file, expiry, download failure, and audit evidence without real personal data. Escalate privacy interpretation and retention decisions rather than making them in the test lane."],
  "outsource-webhook-signature-testing": ["Prove signature handling with replay-safe payloads.", "Prepare valid, altered, missing, stale, and differently encoded payload fixtures. Define the expected response and side effect for every case before sending anything.", "Use a local or sandbox receiver and confirm rejected events produce no duplicate effect. Keep secrets out of evidence and route signing-policy changes to the service owner."],
  "outsource-workflow-state-qa": ["Map a workflow as explicit transitions and guards.", "List each state, allowed next action, blocked action, actor, and expected audit record. Include refresh and direct-link cases because state can be lost between screens.", "Run the matrix with isolated fixtures and record the first unexpected transition. Product policy and exception handling stay with the owner while the programmer supplies reproducible evidence."],
};
for (const post of blogPosts.filter((item) => item.published === "2026-08-14")) {
  const [heading, first, second] = aug14Angles[post.slug];
...
for (const [slug, detail] of Object.entries(september2BlogDetails)) blogDetails[slug] = detail;
