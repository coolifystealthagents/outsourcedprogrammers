...
export const blogPosts: ReadonlyArray<{ slug: string; title: string; excerpt: string; minutes: number; published?: string }> = [
  ...
  { slug: "outsource-mobile-app-release-checks", title: "Outsource mobile app release checks with a device matrix", excerpt: "Turn mobile release confidence into named devices, core flows, evidence, and an owner-approved checklist.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-sql-query-review", title: "Outsource SQL query review with measured safeguards", excerpt: "Review slow or risky queries using representative fixtures, explain plans, and a controlled approval path.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-figma-component-qa", title: "Outsource Figma component QA for consistent interfaces", excerpt: "Compare implemented components with approved states across responsive layouts and accessible interactions.", minutes: 7, published: "2026-08-11" },
  { slug: "outsource-redis-cache-testing", title: "Outsource Redis cache testing without hiding stale data", excerpt: "Test expiry, invalidation, fallback, and failure behavior with safe fixtures and observable results.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-web-performance-budget", title: "Outsource web performance budget checks", excerpt: "Make page speed work actionable with route-level budgets, repeatable measurements, and reviewable changes.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-customer-import-qa", title: "Outsource customer import QA with protected fixtures", excerpt: "Validate mappings, duplicate handling, failures, and recovery without exposing real customer records.", minutes: 9, published: "2026-08-11" },
  { slug: "outsource-oauth-integration-testing", title: "Outsource OAuth integration testing with safe test accounts", excerpt: "Exercise consent, callback, expiry, and denial paths while credentials and provider settings stay controlled.", minutes: 9, published: "2026-08-11" },
  { slug: "outsource-frontend-error-monitoring", title: "Outsource frontend error monitoring improvements", excerpt: "Turn noisy browser errors into useful ownership, reproduction clues, and prioritized maintenance tickets.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-api-pagination-testing", title: "Outsource API pagination testing with boundary cases", excerpt: "Check cursors, limits, empty pages, ordering, and duplicate results using predictable fixtures.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-email-template-qa", title: "Outsource email template QA across real clients", excerpt: "Review layout, links, plain-text fallbacks, and personalization with safe preview data.", minutes: 7, published: "2026-08-11" },
  { slug: "outsource-privacy-settings-qa", title: "Outsource privacy settings QA with permission-aware cases", excerpt: "Test consent, visibility, export, and account settings without turning QA into a data-access risk.", minutes: 9, published: "2026-08-11" },
  { slug: "outsource-cron-job-maintenance", title: "Outsource cron job maintenance with recovery evidence", excerpt: "Document schedules, retries, duplicate protection, and failure ownership before changing recurring work.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-typescript-type-cleanup", title: "Outsource TypeScript type cleanup in reviewable slices", excerpt: "Reduce type debt without masking runtime behavior, widening scope, or burying risky changes in a large diff.", minutes: 7, published: "2026-08-11" },
  { slug: "outsource-accessibility-regression-testing", title: "Outsource accessibility regression testing for key flows", excerpt: "Pair keyboard, focus, labels, and contrast checks with clear evidence and a named remediation owner.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-file-upload-testing", title: "Outsource file upload testing with safe boundaries", excerpt: "Test size limits, rejected formats, retries, progress, and storage behavior using non-sensitive fixtures.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-feature-flag-rollout-qa", title: "Outsource feature flag rollout QA with rollback rules", excerpt: "Verify enabled, disabled, targeted, and expired states before a feature reaches more users.", minutes: 8, published: "2026-08-11" },
  { slug: "outsource-analytics-event-audit", title: "Outsource analytics event audits without losing product meaning", excerpt: "Check event names, properties, privacy, and trigger conditions against a documented measurement plan.", minutes: 8, published: "2026-08-11" },
