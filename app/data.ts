...
export const blogPosts = [
  ...
  { slug: "outsourced-programmer-acceptance-criteria", title: "Write acceptance criteria for outsourced programming work", excerpt: "Turn a broad request into observable behavior, evidence, and a reviewable finish line.", minutes: 7 },
  { slug: "outsource-graphql-schema-review", title: "Outsource GraphQL schema review with client safeguards", excerpt: "Review schema changes against clients, fixtures, compatibility rules, and owner approval.", minutes: 9 },
  { slug: "outsource-api-rate-limit-testing", title: "Outsource API rate limit testing with safe fixtures", excerpt: "Test throttling, retry behavior, and error responses without exposing production credentials.", minutes: 8 },
  { slug: "outsource-nextjs-metadata-audit", title: "Outsource a Next.js metadata audit with route evidence", excerpt: "Check titles, canonicals, structured data, and sitemap inputs through a bounded review lane.", minutes: 8 },
  { slug: "outsource-react-accessibility-fixes", title: "Outsource React accessibility fixes with reproducible checks", excerpt: "Pair keyboard and assistive-technology findings with fixtures, acceptance rules, and review.", minutes: 9 },
  { slug: "outsource-database-migration-dry-run", title: "Outsource a database migration dry run safely", excerpt: "Use representative fixtures, rollback evidence, and owner approval before migration changes.", minutes: 9 },
  { slug: "outsource-queue-observability", title: "Outsource queue observability improvements", excerpt: "Make retries, dead letters, latency, and failure ownership easier to inspect.", minutes: 8 },
  { slug: "outsource-cypress-test-maintenance", title: "Outsource Cypress test maintenance with stable fixtures", excerpt: "Keep browser tests useful by defining behavior, fixtures, failure evidence, and review rules.", minutes: 8 },
  { slug: "outsource-frontend-form-validation", title: "Outsource frontend form validation with clear cases", excerpt: "Test required fields, errors, recovery, and submission behavior with safe fixtures.", minutes: 8 },
  { slug: "outsource-search-index-maintenance", title: "Outsource search index maintenance with measured checks", excerpt: "Scope indexing work around mappings, stale records, relevance evidence, and rollback.", minutes: 9 },
  { slug: "outsource-customer-portal-qa", title: "Outsource customer portal QA with permission-aware fixtures", excerpt: "Test important portal flows while protecting customer data and keeping release authority internal.", minutes: 9 },
  { slug: "outsource-auth-session-review", title: "Outsource authentication session review carefully", excerpt: "Check expiry, logout, renewal, and access boundaries with named test accounts.", minutes: 9 },
  { slug: "outsource-image-optimization", title: "Outsource image optimization with measurable page checks", excerpt: "Improve asset delivery while preserving visual behavior, accessibility, and owner review.", minutes: 7 },
  { slug: "outsource-billing-webhook-reconciliation", title: "Outsource billing webhook reconciliation testing", excerpt: "Use sandbox events and reconciliation evidence while payment decisions stay with your team.", minutes: 9 },
  { slug: "outsource-integration-contract-testing", title: "Outsource integration contract testing with fixtures", excerpt: "Protect service boundaries by pairing request examples, compatibility checks, and clear ownership.", minutes: 8 },
  { slug: "outsource-technical-debt-inventory", title: "Outsource a technical debt inventory with useful evidence", excerpt: "Turn scattered maintenance concerns into bounded items with impact, owner, and next action.", minutes: 8 },
  { slug: "outsource-staging-environment-parity", title: "Outsource staging environment parity checks", excerpt: "Compare safe configuration and behavior evidence without granting uncontrolled production access.", minutes: 8 },
  { slug: "outsource-error-boundary-testing", title: "Outsource React error boundary testing", excerpt: "Exercise failure states, recovery, logging, and user messaging with reviewable cases.", minutes: 8 },
  { slug: "outsource-marketing-site-seo-maintenance", title: "Outsource marketing site SEO maintenance with guardrails", excerpt: "Keep route metadata, internal links, and technical checks accurate through a controlled workflow.", minutes: 8 },
  { slug: "outsource-code-ownership-handoff", title: "Outsource a code ownership handoff without losing context", excerpt: "Capture decisions, reviewers, setup commands, and open risks before responsibility changes.", minutes: 7 },
  { slug: "outsource-feature-acceptance-testing", title: "Outsource feature acceptance testing with owner review", excerpt: "Convert product expectations into scenarios, evidence, and a clear approval path.", minutes: 8 },
  { slug: "outsource-backlog-cleanup", title: "Outsource backlog cleanup with decision boundaries", excerpt: "Improve ticket quality and remove stale work while product priorities remain with your team.", minutes: 7 },
] as const;
