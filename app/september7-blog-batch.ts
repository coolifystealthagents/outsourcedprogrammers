...
const topics: Topic[] = [
  {
    slug: "outsource-passkey-recovery-path-qa",
    title: "Test passkey recovery paths before users get locked out",
    excerpt:
  ...
  {
    slug: "outsource-postgres-failover-connection-qa",
    title: "Check application connections during a PostgreSQL failover drill",
    excerpt:
  ...
  {
    slug: "outsource-signed-download-expiry-testing",
    title: "Test signed download expiry with two clocks and one clear policy",
    excerpt:
  ...
  {
    slug: "outsource-csv-formula-injection-qa",
    title: "Check CSV exports for spreadsheet formula injection",
    excerpt:
  ...
  {
    slug: "outsource-mobile-offline-conflict-qa",
    title: "Test mobile offline edits when two devices reconnect",
    excerpt:
  ...
  {
    slug: "outsource-graphql-depth-limit-review",
    title: "Review GraphQL depth limits with queries that resemble real work",
    excerpt:
  ...
  {
    slug: "outsource-email-bounce-state-reconciliation",
    title: "Reconcile email bounce states across provider and application records",
    excerpt:
  ...
  {
    slug: "outsource-feature-entitlement-cache-qa",
    title: "Test cached feature entitlements after a plan change",
    excerpt:
  ...
  {
    slug: "outsource-object-storage-multipart-cleanup",
    title: "Audit abandoned multipart uploads before storage quietly grows",
    excerpt:
  ...
  {
    slug: "outsource-api-idempotency-key-scope-review",
    title: "Define the boundary of an API idempotency key before testing retries",
    excerpt:
  ...
  {
    slug: "outsource-service-worker-update-recovery",
    title: "Test service worker updates when old tabs refuse to disappear",
    excerpt:
  ...
  {
    slug: "outsource-browser-extension-permission-review",
    title: "Review browser extension permissions before a managed rollout",
    excerpt:
    ...
    sections: [
      {
        ...
        paragraphs: [
          `${t.title}. ${t.problem} Turn that concern into one case with an expected result. Name the environment, source revision, and person who will accept or reject the outcome.`,
...
export const september7BlogBatch = topics.map(({ slug, title, excerpt }) => ({
  slug,
  title,
  excerpt,
  minutes: 10,
...
export const september7BlogDetails: Record<string, BlogDetail> =
